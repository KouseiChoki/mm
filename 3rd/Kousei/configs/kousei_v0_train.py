...
LastEditTime: 2023-09-27 14:31:57
...
_CN.kousei.crop_size = [1072, 1920]
...
#stage setting
_CN.kousei.stage_sintel_clean = [20,1,1.2] #nums,min_scale,max_scale
_CN.kousei.stage_sintel_final = [40,1,1.2]
_CN.kousei.stage_things_clean = [1,1,1.2]
_CN.kousei.stage_things_final = [1,1,1.2]
_CN.kousei.stage_unreal_clean = [4,0,0.1]
_CN.kousei.stage_unreal_final = [0,0,0.1]
_CN.kousei.stage_spring_clean = [1,0,0.1]
#image setting
...
_CN.restore_ckpt = '/home/rg0775/QingHong/MM/motionmodel/3rd/Kousei/train_checkpoints/0918_16x_600k/140000_ff.pth'
################################################
################################################
_CN.MOFNetStack = CN()
