...
_CN.kousei.crop_size = [536, 960]
_CN.kousei.crop_size = [536, 960]
_CN.kousei.max_mv_x = 0.8
_CN.kousei.max_mv_y = 1
_CN.kousei.motion_blur_rate = 0
_CN.kousei.reverse_rate=0.3
_CN.kousei.repeat_frame_rate = 0.05

#stage setting
_CN.kousei.stage_sintel_clean = [20,-0.2,0.2] #nums,min_scale,max_scale
_CN.kousei.stage_sintel_final = [40,-0.2,0.2]
_CN.kousei.stage_things_clean = [1,-0.2,0.2]
_CN.kousei.stage_things_final = [1,-0.2,0.2]
_CN.kousei.stage_unreal_clean = [4,-1,-0.6]
_CN.kousei.stage_unreal_final = [6,-1,-0.6]
_CN.kousei.stage_spring_clean = [1,-1,-0.6]
...
_CN.MOFNetStack.cnet = 'basicencoder2'
_CN.MOFNetStack.fnet = 'basicencoder2'
...
_CN.MOFNetStack.decoder_depth = 5
