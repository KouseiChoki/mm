...
LastEditTime: 2024-01-09 18:07:45
...
#stage setting
_CN.kousei.stage_sintel_clean = [20,-1,-0.6] #nums,min_scale,max_scale
_CN.kousei.stage_sintel_final = [40,-1,-0.6]
_CN.kousei.stage_things_clean = [1,-1,-0.6]
_CN.kousei.stage_things_final = [1,-1,-0.6]
_CN.kousei.stage_unreal_clean = [4,-2,-1]
_CN.kousei.stage_unreal_final = [0,-2,-1]
_CN.kousei.stage_spring_clean = [1,-2,-1]
