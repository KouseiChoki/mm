...
_CN.kousei.stage_unreal_clean = [0,0,0.1]
_CN.kousei.stage_unreal_final = [0,0,0]
_CN.kousei.stage_spring_clean = [0,0,0.1]
_CN.kousei.stage_unreal_MRQ_clean = [1,0,0.1]
_CN.kousei.stage_unreal_MRQ_final = [0,0,0.1]

#image setting
_CN.kousei.img_type = 'image' #hdr or image(ldr)

#mask setting
_CN.kousei.mask_type = 'fg'  # mix bg fg none
...
_CN.restore_ckpt = '/tt/nas/qhong/motionmodel/checkpoints/kousei-mask-fg-v0-230808300.pth'
################################################
################################################
_CN.MOFNetStack = CN()
