...
_CN.kousei.motion_blur_rate = 0.2
_CN.kousei.reverse_rate=0.3
_CN.kousei.repeat_frame_rate = 0.02

#stage setting
_CN.kousei.stage_sintel_clean = [0,0,0] #nums,min_scale,max_scale
_CN.kousei.stage_sintel_final = [0,0,0]
_CN.kousei.stage_things_clean = [1,0,0]
_CN.kousei.stage_things_final = [1,0,0]
_CN.kousei.stage_unreal_clean = [10,-1,-0.6]
_CN.kousei.stage_unreal_final = [0,-1,-0.6]
_CN.kousei.stage_spring_clean = [0,-1,-0.6]


_CN.kousei.stage_unreal_MRQ_clean = [0,-1,-0.6]

#image setting
_CN.kousei.img_type = 'ldr' #hdr or image(ldr)

#mask setting
_CN.kousei.mask_type = 'mix'  # mix bg fg none
_CN.kousei.mask_treshold=120
_CN.kousei.mask_enhance_rate = 0.5
_CN.kousei.mask_enhance_range = [-2,-1]
...
_CN.restore_ckpt = '/tt/nas/qhong/motionmodel/3rd/Kousei/train_checkpoints/0911_mix/300000_ff.pth'
################################################
################################################
_CN.MOFNetStack = CN()
