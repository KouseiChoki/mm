...
LastEditTime: 2024-09-03 13:49:33
...
#stage setting
_CN.kousei.stage_sintel_clean = [20,0,0] #nums,min_scale,max_scale
_CN.kousei.stage_sintel_final = [40,0,0]
...
_CN.kousei.stage_spring_clean = [4,-1,-0.6]
