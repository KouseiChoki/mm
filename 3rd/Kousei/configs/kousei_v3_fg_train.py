...
#stage setting
_CN.kousei.stage_sintel_clean = [0,-1,-0.6] #nums,min_scale,max_scale
_CN.kousei.stage_sintel_final = [0,-1,-0.6]
_CN.kousei.stage_things_clean = [1,-1,-0.6]
_CN.kousei.stage_things_final = [1,-1,-0.6]
_CN.kousei.stage_unreal_clean = [10,-2,-1]
_CN.kousei.stage_unreal_final = [2,-2,-1]
_CN.kousei.stage_spring_clean = [0,-2,-1]
...
_CN.MOFNetStack.cnet = 'basicencoder3'
_CN.MOFNetStack.fnet = 'basicencoder3'
