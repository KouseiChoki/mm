...
- **默认值**: `'mono_depth'`
- **是否必需**: 否
- **示例**: `--name depth_estimation`

### 2. `--root`
- **说明**: 根目录路径。
- **类型**: 字符串
- **是否必需**: 否
- **示例**: `--root /your/root/path`
...
- **说明**: 深度算法模式。
- **类型**: 字符串
- **默认值**: `'depth_anything_v2_metric_hypersim_vitl'`
- **是否必需**: 否
- **示例**: `--algo depth_anything_v2_metric_hypersim_vitl`
...
- **说明**: 服务器地址。
- **类型**: 字符串
- **默认值**: `'http://10.35.116.93:8088'`
- **是否必需**: 否
- **示例**: `--server http://localhost:8080`

### 8. `--img_folder_name`
- **说明**: 批处理运行的文件夹名称。
- **类型**: 字符串
- **是否必需**: 否
- **示例**: `--img_folder_name batch_images`
